    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <!-- Product Card 1 -->
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden slide-in"
                    ...
                    <div class="relative">
                        ...
                        <button onclick="toggleWishlist(this)"
                            class="wishlist-btn absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md">
                            <i class="far fa-heart text-gray-600"></i>
                        </button>
                        <span
                            class="absolute top-3 left-3 bg-red-500 text-white px-2 py-1 rounded-full text-xs font-medium">-20%</span>
                        <div
                            class="absolute bottom-3 left-3 flex items-center bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-sm text-gray-600 mb-3 line-clamp-2">Laptop gaming dengan spesifikasi tinggi untuk
                            performa maksimal</p>
