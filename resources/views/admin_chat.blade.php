                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-0">
                                ...
                                @if($users->count() > 0)
                                    @foreach($users as $user)
                                        <div class="user-item p-4 border-b border-gray-200 cursor-pointer"
                                            onclick="loadUserChat({{ $user->id }}, '{{ $user->nama }}')"
                        ...
                        <div class="md:col-span-2">
                            <div id="chatArea" class="chat-container flex flex-col">
                                <!-- Chat Header -->
                                <div id="chatHeader"
                                    class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            <div
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm opacity-75">Klik pada daftar pengguna untuk memulai
                                                    chat</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="messagesContainer" class="messages-container scrollbar-custom p-4 space-y-4">
                                    <div class="flex justify-center items-center h-full">
                                        <div class="text-center">
                                            ...
                                            <p class="text-gray-500 text-lg">Pilih pengguna dari daftar untuk memulai
                                                percakapan</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="chatInput" class="border-t border-gray-200 p-4" style="display: none;">
                                    <form id="chatForm" class="flex items-center space-x-2">
                                        ...
                                        <button type="submit"
                                            class="bg-indigo-500 hover:bg-indigo-600 text-white rounded-full px-4 py-2 transition-colors"
                                            disabled>
