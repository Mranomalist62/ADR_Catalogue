...
<body class="bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Platform e-commerce terpercaya yang menyediakan berbagai produk
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Menjadi platform pilihan utama untuk kebutuhan belanja
                                    sehari-hari dengan memberikan pengalaman terbaik.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Menghubungkan pelanggan dengan produk terbaik melalui teknologi
                                    yang inovatif.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slide-in" style="animation-delay: 0.2s">
                    <div class="relative">
                        <div class="light-blue-gradient rounded-2xl p-8 text-center">
                            <div
                                class="w-32 h-32 mx-auto bg-white rounded-full flex items-center justify-center shadow-lg mb-6">
    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="stat-card bg-white rounded-xl shadow-lg p-6 text-center slide-in"
            ...
            <div class="space-y-12">
                ...
                <div class="timeline-item relative flex items-center">
                    <div class="w-1/2 pr-8 text-right">
                        ...
                        <p class="text-gray-600">ADR Catalogue didirikan dengan visi menjadi platform e-commerce
                            terpercaya.</p>
                    </div>
                    <div
                        class="flex-shrink-0 w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center z-10 mx-4">
                        <i class="fas fa-flag text-white"></i>
                    </div>
                    <div class="w-1/2"></div> <!-- Empty spacer for right side -->
                </div>

                <!-- Item 2: Right side -->
                <div class="timeline-item relative flex items-center">
                    <div class="w-1/2"></div> <!-- Empty spacer for left side -->
                    <div
                        class="flex-shrink-0 w-12 h-12 bg-sky-600 rounded-full flex items-center justify-center z-10 mx-4">
                ...
                <div class="timeline-item relative flex items-center">
                    <div class="w-1/2 pr-8 text-right">
                        ...
                        <p class="text-gray-600">Menerima penghargaan sebagai platform e-commerce terbaik di kategori.
                        </p>
                    </div>
                    <div
                        class="flex-shrink-0 w-12 h-12 bg-indigo-600 rounded-full flex items-center justify-center z-10 mx-4">
                ...
                <div class="timeline-item relative flex items-center">
                    <div class="w-1/2"></div> <!-- Empty spacer for left side -->
                    <div
                        class="flex-shrink-0 w-12 h-12 bg-cyan-600 rounded-full flex items-center justify-center z-10 mx-4">
    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="card-hover bg-white rounded-xl shadow-lg overflow-hidden text-center slide-in"
