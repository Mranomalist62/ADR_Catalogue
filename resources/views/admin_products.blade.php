                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                ...
                                <div>
                                    <label for="harga_setelah_diskon"
                                        class="block text-sm font-medium text-gray-700 mb-2">Harga Setelah
                                        Diskon</label>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($products as $product)
                                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <div class="flex items-center">
                                                @if($product->path_thumbnail)
                                                    <img src="{{ asset($product->path_thumbnail) }}" alt="{{ $product->nama }}"
                                                        class="h-10 w-10 rounded-lg object-cover">
                                                @else
                                                    <div
                                                        class="h-10 w-10 rounded-lg bg-gray-200 flex items-center justify-center">
                                                        <span
                                                            class="text-xs font-medium">{{ substr($product->nama, 0, 2) }}</span>
                                                    </div>
                                                @endif
                                                <div class="ml-3">
                                                    <div class="text-sm font-medium text-gray-900">{{ $product->nama }}
                                                    </div>
                                        ...
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm font-medium {{ $product->diskon > 0 ? 'text-green-600' : 'text-gray-900' }}">
                                            Rp
                                            {{ number_format($product->harga * (1 - $product->diskon / 100), 0, ',', '.') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
