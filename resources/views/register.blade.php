...
<body
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 py-12 px-4">
    <!-- Background Pattern -->
    <div class="fixed inset-0 z-0">
        <div class="absolute inset-0 register-gradient opacity-90"></div>
        <div class="absolute inset-0">
            <div
                class="absolute top-20 left-20 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 float-animation">
            </div>
            <div class="absolute top-40 right-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 float-animation"
                style="animation-delay: 2s;"></div>
            <div class="absolute -bottom-8 left-40 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 float-animation"
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 slide-in" style="animation-delay: 0.1s">
            ...
            <form action="{{ route('register.submit') }}" method="POST" class="space-y-4">
                ...
                <div class="slide-in" style="animation-delay: 0.2s">
                    ...
                    <div class="relative">
                        <input type="text" id="nama" name="nama" placeholder="John Doe" value="{{ old('nama') }}"
                            required
                ...
                <div class="slide-in" style="animation-delay: 0.4s">
                    ...
                    <div class="relative">
                        <input type="tel" id="nomor_handphone" name="nomor_handphone" placeholder="0812-3456-7890"
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-700">
                            Saya setuju dengan <a href="#" class="text-indigo-600 hover:text-indigo-500">Syarat dan
                                Ketentuan</a> serta <a href="#" class="text-indigo-600 hover:text-indigo-500">Kebijakan
                                Privasi</a>
                        </label>
                    </div>
                </div>
        ...
        <div class="text-center mt-6 slide-in" style="animation-delay: 1.1s">
            <p class="text-white">
                ...
                <a href="{{ route('profile') }}"
                    class="font-medium text-white hover:underline ml-4 inline-flex items-center transition-colors">
