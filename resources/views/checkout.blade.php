            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('checkout') }}"
                        class="nav-link group relative px-3 py-2 text-blue-600 font-medium transition-all duration-300">
                        <span class="flex items-center">
        ...
        <div class="mb-8 fade-in">
            <div class="flex items-center justify-center">
                <div class="flex items-center">
                    <div
                        class="step-indicator active flex items-center justify-center w-12 h-12 rounded-full border-2 border-purple-500 font-semibold shadow-lg">
                    ...
                    <div
                        class="step-indicator flex items-center justify-center w-12 h-12 rounded-full border-2 border-gray-300 font-semibold shadow-lg">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="glass-effect rounded-xl shadow-xl p-6 fade-in">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div class="payment-method rounded-lg p-4 cursor-pointer" onclick="selectPayment('transfer')">
                            <div class="flex items-center">
                                <input type="radio" name="payment_method" value="transfer" id="transfer" required
                                    class="mr-3" checked>
                                <div class="flex-1">
                                    <label for="transfer"
                                        class="font-medium text-gray-900 cursor-pointer flex items-center">
                        ...
                        <div class="payment-method rounded-lg p-4 cursor-pointer" onclick="selectPayment('ewallet')">
                            <div class="flex items-center">
                        ...
                        <div class="payment-method rounded-lg p-4 cursor-pointer" onclick="selectPayment('cod')">
                            <div class="flex items-center">
                                <input type="radio" name="payment_method" value="cod" id="cod" required class="mr-3">
                                <div class="flex-1">
                ...
                <div class="glass-effect rounded-xl shadow-xl p-6 sticky top-24 fade-in">
                    ...
                    <div class="border-t border-gray-200 pt-4 space-y-3">
                        ...
                        <div
                            ...
                            <span>Total</span>
                            <span class="text-purple-600">Rp
                                {{ number_format($total + 15000 + ($total * 0.1), 0, ',', '.') }}</span>
                        </div>
                    </div>

                    <form action="{{ route('pembayaran') }}" method="POST" class="mt-6">
                        @csrf
                        <button type="submit" class="btn-primary w-full py-3 text-white rounded-lg font-medium pulse">
